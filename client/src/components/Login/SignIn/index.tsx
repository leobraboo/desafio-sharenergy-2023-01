      ...
      <div className="flex items-center justify-center">
        <div>
          ...
          <form style={{ width:"20rem" }} className="mt-8 space-y-8">
            ...
            <div>
              <button  type="button" className=" relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
